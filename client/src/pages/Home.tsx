  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background crt-flicker">
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8">
          <div className="space-y-2">
            <h1 className="text-7xl md:text-9xl font-bold text-primary glow-text tracking-tighter">
              PONG
            </h1>
          ...
          <div className="flex flex-col gap-4 w-full max-w-xs">
            <ArcadeButton size="lg" onClick={() => setIsPlaying(true)}>
        ...
        <div className="bg-black border-4 border-primary p-6 shadow-[0_0_20px_rgba(57,255,20,0.2)] w-full relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {isLoading ? (
              ...
              <div className="h-64 flex items-center justify-center text-red-500 font-mono text-center p-4 border border-red-500/30 bg-red-900/10">
                CONNECTION ERROR.<br/>PLEASE CHECK CABLE.
              </div>
            ) : scores?.length === 0 ? (
              ...
              <ul className="space-y-4 font-mono text-lg h-80 overflow-y-auto pr-2 custom-scrollbar">
      ...
      <footer className="fixed bottom-4 text-xs text-muted-foreground opacity-40 font-mono">
        © 1972 ATARI INC. REIMAGINED 2024
      </footer>
    </div>
  );
}
